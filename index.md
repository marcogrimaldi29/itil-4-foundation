---
layout: home
title: ITIL 4 Foundation — Study Notes
nav_order: 1
description: "Study notes for the ITIL 4 Foundation certification — covering the Service Value System, 7 guiding principles, 4 dimensions, service value chain, and all practices. Includes exam caveats and cheatsheet."
permalink: /
mermaid: true
---
...
flowchart TD
    F["🎓 ITIL 4 Foundation\n(these notes)"]
    MP["📘 ITIL 4 Managing Professional\n4 modules"]
    SL["📗 ITIL 4 Strategic Leader\n2 modules"]
    M["🏆 ITIL 4 Master"]
    F --> MP
    F --> SL
    MP --> M
    SL --> M
    style F fill:#220826,stroke:#e879f9,color:#fae8ff
```
...
[⭐ Star this repo](https://github.com/marcogrimaldi29/itil-4-foundation){: .btn .btn-outline .fs-5 .mb-4 .mb-md-0 }
